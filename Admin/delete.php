...
<body>
    <!-- récupère l'id du message puis le supprime avec une requête SQL et un texte de confirmation -->
    <?php
        $servername = "localhost";
        $dbUsername = "root";
        $dbPassword = "";
        ...
        if (isset($_GET['id'])) {
            ...
            echo "<script>window.location.href = 'panel_admin.php';</script>"; // Remplacez 'index.php' par la page sur laquelle vous souhaitez rediriger après la suppression
        } else {
